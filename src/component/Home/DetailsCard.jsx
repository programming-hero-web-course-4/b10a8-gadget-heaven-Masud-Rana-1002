      ...
      <div className="flex lg:flex-row flex-col items-center lg:items-start gap-7">
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <div
              onClick={() => sendWishlistData(data)}
              className={`${
                heartIconDisabled === true
                  ? ""
                  : "disabled:opacity-75 bg-gray-300 text-white "
              } w-12 h-12 rounded-full border flex justify-center items-center text-6xl p-1 cursor-pointer`}
            >
              <CiHeart />
            </div>
          </div>
